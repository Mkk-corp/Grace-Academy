...
const CONTENT = {
  en: {
    ...
    intro: 'Grace Academy is committed to protecting your personal information. This Privacy Policy explains how we collect, use, and safeguard data when you use our website and services.',
    sections: [
      {
  ...
  ar: {
    ...
    intro: 'تلتزم أكاديمية جريس بحماية معلوماتك الشخصية. توضح سياسة الخصوصية هذه كيفية جمعنا للبيانات واستخدامها وحمايتها عند استخدامك لموقعنا وخدماتنا.',
    sections: [
      {
          ...
          <div className="legal-hero__inner">
            ...
            <div className="legal-hero__text">
              ...
              <div className="legal-hero__badge">
                <svg width="10" height="10" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5"><path d="M12 2L3 7v9c0 4 9 6 9 6s9-2 9-6V7z"/></svg>
                {isAr ? 'سياسة الخصوصية' : 'PRIVACY POLICY'}
              </div>

              <h1 className="legal-hero__title">
                {isAr ? <>بياناتك<br /><span>في أمان</span></> : <>Your data,<br /><span>protected.</span></>}
              </h1>
