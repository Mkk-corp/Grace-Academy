...
const S = {
  en: {
    ...
    colAssessor: 'Assessor', colSubmitted: 'Submitted', colDays: 'Days Changed', colStatus: 'Status', colActions: 'Actions',
    ...
    emptyAll: 'No requests yet', emptyAllDesc: 'Schedule change requests from assessors will appear here for review.',
  ...
  ar: {
    ...
    colAssessor: 'المُقيّم', colSubmitted: 'تاريخ الإرسال', colDays: 'الأيام المُغيَّرة', colStatus: 'الحالة', colActions: 'الإجراءات',
    ...
    emptyAll: 'لا توجد طلبات بعد', emptyAllDesc: 'ستظهر هنا طلبات تغيير الجدول من المُقيِّمين.',
