...
const ICONS = {
  ...
  payroll:    <><path d="M4 2v20l2-1 2 1 2-1 2 1 2-1 2 1 2-1 2 1V2l-2 1-2-1-2 1-2-1-2 1-2-1z"/><line x1="8" y1="10" x2="16" y2="10"/><line x1="8" y1="14" x2="16" y2="14"/></>,
      ...
      <div className="admin-layout">
        ...
        <aside style={{
          ...
          <nav style={{ flex: 1, overflowY: 'auto', overflowX: 'hidden', padding: '10px 0', scrollbarWidth: 'thin', scrollbarColor: `${border} transparent` }}>
            ...
            {/* Courses Catalog */}
            <NavLink href="/admin/courses" label={isAr ? 'كتالوج الدورات' : 'Courses Catalog'} icon="courses" startsWith />
            ...
            {/* Payroll */}
            <NavLink href="/admin/payroll" label={isAr ? 'الرواتب' : 'Payroll'} icon="payroll" startsWith />
          </nav>
